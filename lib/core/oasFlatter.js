...
/**
 * Method that will flatten definition/schema of an open api specification V2 or V3.
 * It replaces "$ref" by the full object
 * @param specOas - open api specification json object to flatten
 * @returns {object}
 */
